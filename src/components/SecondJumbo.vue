<template>
    <div class="section pt-5">
        <div class="container text-start d-flex">
            <div class="col-50 img"></div>
            <div class="col-50 p-4">
                <TitleAndSubtitle :title="'Construct A'" :title-last-word="'Stunning'" :display-second-title="true"
